...
<div class="about-top heading">
	<h4>Welcome to Cy_BM for Ordering</h4>
</div>
</div>
<br>
...
<div id="right">
	<table width="900" cellpadding=3 cellspacing=1 align=center class=tableborder1 border="1px" bordercolor="grey">
		<tr>
			...
			<td valign=middle align=center height=35 background="images/bg2.gif" width=""><font color="#ffffff"><b>库存数量</b></font></td>
			<td valign=middle align=center height=35 background="images/bg2.gif" width=""><font color="#ffffff"><b>操作</b></font></td>
		</tr>
		<c:forEach items="${applicationScope.books }" var="book" varStatus="vs">
         	<tr>
				<td height=25 bgcolor="#E4F3FF" valign=middle align=center width="">${vs.index+1 }</td>
				<td height=25 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp?productid=4">${book.bookName }</a></td>
				<td height=25 bgcolor="#E4F3FF" valign=middle align=center width="">${book.publishHouse }</td>
				<td height=25 valign=middle align=center width="">${book.publishTime }</td>
				<td height=25 bgcolor="#E4F3FF"valign=middle align=center width="">${book.num }</td>
				<td height=25 valign=middle align=center width=""><a href="/BookManagement/AddLittleCarServlet?bookId=${book.id }">
				<img border="0" src="images/pp2.png" width="97" height="18"></a> </td>
			</tr>
         </c:forEach>  
		<!-- <tr>
			<td height=25 bgcolor="#E4F3FF" valign=middle align=center width="">1</td>
			<td height=25 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp?productid=4">Effective Java中文版</a></td>
			<td height=25 bgcolor="#E4F3FF" valign=middle align=center width="">清华大学出版社</td>
			<td height=25 valign=middle align=center width="">2000年9月</td>
			<td height=25 bgcolor="#E4F3FF"valign=middle align=center width="">10</td>
			<td height=25 valign=middle align=center width=""><a href="shopcart.html">
		</tr>
		<tr>
			<td height=25 bgcolor="#E4F3FF" valign=middle align=center width="">1</td>
			<td height=25 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp?productid=4">Effective Java中文版</a></td>
