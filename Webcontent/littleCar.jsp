...
<div class="about-top heading">
	<h4>Welcome to Cy_BM for LittleCar</h4>
</div>
</div>
<br>
...
<div id="right">
	<table width="900" cellpadding=3 cellspacing=1 align=center class=tableborder1 border="1px" bordercolor="grey">
		...
		<c:forEach items="${sessionScope.littleCar.map }" var="line" varStatus="vs">
			<tr>
				<td height=25 bgcolor="#E4F3FF" valign=middle align=center width="">${vs.index+1 }</td>
				<td height=25 valign=middle width="" align=center>&nbsp;&nbsp;<a href="productDetail.jsp?productid=4">${line.value.book.bookName }</a></td>
				<td height=25 bgcolor="#E4F3FF" valign=middle align=center width="">${line.value.book.publishHouse }</td>
				<td height=25 valign=middle align=center width="">${line.value.book.publishTime }</td>
			</tr>
		</c:forEach>
		
		<tr>
			<td height="30px" bgcolor="#E4F3FF" valign=middle align=center colspan="5">
			<input type="button" style="background-image: url('images/pp3.png')" value="           " onclick="javascript:window.location='/BookManagement/AddOrderServlet';"> 
			<input type="button" style="background-image: url('images/pp4.png')" value="           " onclick="javascript:window.location='order.jsp';"> 
			<input type="button" style="background-image: url('images/pp5.png')"  value="            " onclick="javascript:window.location='/BookManagement/DeleteAllLineServlet';"></td>
		</tr>
	</table>
</div>
</body>
