...
<marquee behavior="scroll" scrollamount="3"><h2>ChangePasswordS</h2></marquee>
<form name="reg" method="post"  action="/BookManagement/ChangePassSServlet">
	<table cellpadding="3" cellspacing="1" align="center"  >
		...
		<tr>
			...
			<input type="button" value="确定" onclick="javascript:checkReg()">&nbsp;&nbsp;&nbsp;<input type="reset" name="reset" value="清 除"></td>
		</tr>
	</table>
</form>
</body>
